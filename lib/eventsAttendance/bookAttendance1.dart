...
class EventBookAttendance1 extends StatefulWidget {
  const EventBookAttendance1({Key? key}) : super(key: key);

  @override
  State<EventBookAttendance1> createState() => _EventBookAttendance1State();
}

class _EventBookAttendance1State extends State<EventBookAttendance1> {
              ...
              Stack
                ...
                [
                  Container(
                    ...
                    child: const Image(
                      image: AssetImage('assets/About_Dancing-Unsplash.jpg'),
                      fit: BoxFit.cover,),
                  ),
                  Positioned(
                    top: 20,
  ...
  Future<void> saveDateToFirestore(String date) async {
    try {
      ...
      await _firestore.collection('eventAttendance1').add({
        'date': timestamp, // Save the date as a Timestamp
        'email': currentUser.email,
        'profilePictureUrl': profilePictureUrl,
        'yourName': yourName,
      }).then((value) =>  Navigator.pushReplacementNamed(context, 'events'));
