...
class EventsViewAttendancePage extends StatefulWidget {
  const EventsViewAttendancePage({Key? key}) : super(key: key);

  @override
  State<EventsViewAttendancePage> createState() => _EventsViewAttendancePageState();
}

class _EventsViewAttendancePageState extends State<EventsViewAttendancePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: StreamBuilder<QuerySnapshot>(
          stream:
          FirebaseFirestore.instance.collection('eventAttendance').snapshots(),
