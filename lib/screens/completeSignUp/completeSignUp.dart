                      ...
                      [
                            ...
                            child: const Padding(
                              ...
                              child: Row
                                ...
                                [
                                  ...
                                  SizedBox(width: 5,),
                                  Text('Complete Your Profile',style: TextStyle(color: Colors.white),),
                                ],
                              ),
                            ),
                          ),
                                  ...
                                  (
                                    ...
                                    child: _image != null
                                      ...
                                      width: 180,
                                        ...
                                        :
                                    Image.network(
                                      'loggedInUser.profilePictureUrl' ?? 'https://firebasestorage.googleapis.com/v0/b/shereheapp-7a725.appspot.com/o/uploadImage.jpg?alt=media&token=31082b8c-739d-4793-a5fb-51945b4c20db',
                                      fit: BoxFit.cover,
                                      width: 140,
                                      height: 140,
                        ...
                        Row
                          ...
                          [
                            ...
                            Text('Your Name',style: const TextStyle(color: Colors.black),),
                          ],
                        ),
                        ...
                        Row
                          ...
                          [
                            ...
                            const SizedBox(width: 3,),
                            Text('Your Phone number',style: const TextStyle(color: Colors.black),),
                          ],
                        ),
                        const Divider(color: Colors.grey,),
                        const SizedBox(height: 10,),
                              ...
                              [
                                TextFormField
                                  ...
                                  decoration:  InputDecoration
                                    (
                                      helperText: "Kanduyi, Kibabii, Bungoma, Kitale, Webuye...",
                                      ...
                                      label: const Text('Resident',style: TextStyle(color: Colors.white),),
                                ...
                                TextFormField
                                  ...
                                  decoration:  InputDecoration
                                    (
                                      ...
                                      hoverColor: Colors.white,
                                      label: const Text('Favourite Drink',style: TextStyle(color: Colors.white),),
                                      prefixIcon: const Icon(Icons.local_drink,color: Colors.black,)
                                  ),
                                ),
                             ...
                             /* onPressed: () async {
                                if (_formKey.currentState!.validate()) {
                                  ...
                                  try {
                                    ...
                                    loggedInUser.resident=residentEditingController.text;
                                    loggedInUser.hobbies=hobbiesEditingController.text;
                                    loggedInUser.favouriteDrink=favDrinkEditingController.text;
                                    await FirebaseFirestore.instance.collection('users')
                                        .doc(user!.uid)
