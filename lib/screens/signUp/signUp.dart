              ...
              return Container(
                  ...
                  child:  SingleChildScrollView(
                    child:  Column
                      ...
                      children:
                      [
                        const Text('Welcome To Antonios App!',
                        ...
                        const Padding(
                          ...
                          child: Text('Feels Good to see you',
                            textAlign: TextAlign.center,
                        ...
                        const Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text('Please create an account', style: TextStyle(color: Colors.white,fontSize: 20),
                                ...
                                [
                                  TextFormField
                                    ...
                                    decoration: const InputDecoration(
                                      ...
                                      labelText: 'Your name',labelStyle: TextStyle(color: Colors.black),
                                  ...
                                  TextFormField
                                    ...
                                    decoration:  InputDecoration(
                                      ...
                                      hoverColor: Colors.white,
                                      labelText: 'Create password',labelStyle: const TextStyle(color: Colors.black),
                                  ...
                                  TextFormField
                                    ...
                                    decoration:  InputDecoration(
                                      ...
                                      hoverColor: Colors.white,
                                      labelText: 'Confirm password',labelStyle: const TextStyle(color: Colors.black),
                                      prefixIcon: const Align(
                                        widthFactor: 1.0,
                                        heightFactor: 1.0,
                                        child: Icon(
                            ...
                            showDialog(
                              ...
                              builder: (BuildContext context) {
                                return AlertDialog(
                                  ...
                                  content: const Text('Welcome to Antonios App, a social networking and entertainment facilitating App that'
                                      ' connects users with clubs, hotels, events, and fellow party-goers Our platform allows you to discover '
                                      'parties, connect with attendees, and chat with potential new friends.'),
                                  actions: [
                                    TextButton(
                                      onPressed: () {
                                  ...
                                  content: SingleChildScrollView(
                                      child: Container(
                                        ...
                                        child: const SingleChildScrollView(
                                          child: Text(
                                            'The following are the terms and policies of Antonios App:\n\n'
