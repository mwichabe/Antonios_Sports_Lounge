                ...
                return Padding(
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final eventDescription = events['eventDesc'];
                        final Date = events['date'];
                        final mainSpeaker = events['mainSpeaker'];
                        final venue = events['Venue'];
                        final eventOrganiserContact = events['eventOrganiser'];
                                                          ...
                                                          if (index == 0) {
                                                            Navigator.pushReplacement(
                                                                ...
                                                                MaterialPageRoute(
                                                                    builder:
                                                                        (context) =>
                                                                            const EventsViewAttendancePage()));
                                                          } else if (index ==
                                                              1) {
                                                            Navigator.pushReplacement(
                                                                context,
                                                                MaterialPageRoute(
                                                                    builder:
                                                                        (context) =>
                                                                            const EventsViewAttendancePage1()));
                                                          }
                                                        },
                                                        splashColor: Colors.red,
                                                        child: const Card(
