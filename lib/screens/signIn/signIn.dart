...
class _LogInState extends State<LogIn> {
  ...
  void signIn(String email, String password) async {
    if (_emailController.text == 'antoniosadmin@gmail.com' &&
        _passwordController.text == 'Avator@2') {
      try {
        // Perform sign-in
        ...
        Fluttertoast.showToast(msg: 'Admin Credentials are Successful');
      } catch (e) {
        print(e.toString());
